...
#ifndef KillAllFree_KillAllDefine_h
#define KillAllFree_KillAllDefine_h
...
//免费页面接口
#define kFreeUrl @"http://1000phone.net:8088/app/iAppFree/api/free.php?page=%d&number=20&category_id=%@"

//@"http://iappfree.candou.com:8080/free/applications/free?currency=rmb&page=%d&category_id=%@"
